<template>
  <div>
    <div style="margin: 10px 0">
      ...
      <el-input style="width: 200px" placeholder="请输入歌手" suffix-icon="el-icon-user-solid" class="ml-5" v-model="singer"></el-input>
      <el-input style="width: 200px" placeholder="请输入专辑" suffix-icon="el-icon-headset" class="ml-5" v-model="album"></el-input>
    ...
    <el-table :data="tableData" border stripe :header-cell-class-name="'headerBg'"  @selection-change="handleSelectionChange">
      ...
      <el-table-column prop="musicName" label="歌曲名" width="140"></el-table-column>
      <el-table-column prop="singer" label="歌手" width="120"></el-table-column>
      <el-table-column prop="album" label="专辑"></el-table-column>
      <el-table-column prop="issueDate" label="发行时间"></el-table-column>
    ...
    <el-dialog title="歌曲信息" :visible.sync="dialogFormVisible" width="30%" >
      <el-form label-width="80px" size="small">
        ...
        <el-form-item label="发行时间">
          <el-input v-model="form.issueTime" autocomplete="off"></el-input>
        </el-form-item>
...
export default {
  ...
  methods: {
    ...
    del(id) {
      this.request.delete("/music/delete/" + id).then(res => {
        if (res.code === '200') {
    ...
    delBatch() {
      ...
      this.request.post("/music/delete/batch", ids).then(res => {
        if (res.code === '200') {
